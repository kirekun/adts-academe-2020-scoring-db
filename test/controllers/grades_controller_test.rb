...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { comment: @grade.comment, score: @grade.score, status: @grade.status } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { comment: @grade.comment, score: @grade.score, status: @grade.status } }
