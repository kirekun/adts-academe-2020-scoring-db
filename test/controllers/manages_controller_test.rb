...
class ManagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manage" do
    assert_difference('Manage.count') do
      post manages_url, params: { manage: { deadline: @manage.deadline, enable: @manage.enable } }
    end
  ...
  test "should update manage" do
    patch manage_url(@manage), params: { manage: { deadline: @manage.deadline, enable: @manage.enable } }
